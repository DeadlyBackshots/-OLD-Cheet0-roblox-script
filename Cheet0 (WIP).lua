 --CHEET0--
    ...
    local Window = Library.CreateLib("Cheet0", "Sentinel")
                 --MAIN--    
                 local Tab = Window:NewTab("Main")
                 
                 local Section = Tab:NewSection("Main")
                 Section:NewToggle("Toggle Esp", "You can toggle esp from this button", function(state)
                     if state then
    ...
    Section:NewSlider("Walkspeed", "Changes your characters walkspeed", 250, 16, function(s)
        game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = s
    end)
                                  --JUMPPOWER--
    Section:NewSlider("Jumppower", "Changes your characters jumppower", 250, 50, function(v)
        game.Players.LocalPlayer.Character.Humanoid.JumpPower = v
    end)
                                  --Keybinds--  
    local Tab = Window:NewTab("Keybinds")
    Section:NewKeybind("On and off toggle", "This toggles the GUI", Enum.KeyCode.RightAlt, function()
        Library:ToggleUI()
    end)
end
end)